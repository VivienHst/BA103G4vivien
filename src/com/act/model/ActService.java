...
public class ActService {
	...
	public ActVO getOneNoImg(String act_no) {
		return dao.findByPrimaryKeyNoImg(act_no);
	}
	
	public List<Act_pairVO> getAct_pairByMem_ac(String mem_ac){
		
		return dao.getAct_pairByMem_ac(mem_ac);
	}
	
	public List<ActVO> getAllActByMem_acNoImg(String mem_ac) {
		return dao.getAllActByMem_acNoImg(mem_ac);	
	}
